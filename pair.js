...
const fakeForward = {
            ...
            forwardedNewsletterMessageInfo: {
                ...
                newsletterName: '𝕻𝖊𝖆𝖐𝖞-𝖇𝖑𝖎𝖓𝖉𝖊𝖗-𝖒𝖎𝖓𝖎 🎩',
                serverMessageId: '115'
            }
        };
//=======================================
...
const config = {
    ...
    OTP_EXPIRY: 300000,
    NEWS_JSON_URL: '',
    BOT_NAME: 'ᴘᴇᴀᴋʏ-ʙʟɪɴᴅᴇʀ-ᴍɪɴɪ-ʙᴏᴛ',
    OWNER_NAME: '𝙼𝚛 𝙻𝚎𝚎',
    OWNER_NUMBER: '254116266407',
    BOT_VERSION: '1.0.0',
    BOT_FOOTER: '> 𝕻𝖊𝖆𝖐𝖞-𝖇𝖑𝖎𝖓𝖉𝖊𝖗-𝖒𝖎𝖓𝖎',
...
const mongoUrl = 'mongodb+srv://sanglee9146118_db_user:pCLKfSkwOmeLMfQx@cluster0.l2wzjif.mongodb.net/';// add ur own mongodb url
...
function setupCommandHandlers(socket, number) {
    ...
    try {
        ...
        const title = '*🎩𝕻𝖊𝖆𝖐𝖞-𝖇𝖑𝖎𝖓𝖉𝖊𝖗-𝖒𝖎𝖓𝖎*';
        const content = 
            `*© 𝙼𝚛 𝙻𝚎𝚎*\n` +
            `*𝐁ᴏᴛ 𝐎ᴡɴᴇʀ :- 𝙼𝚛 𝙻𝚎𝚎*\n` +
            `*𝐎ᴡᴇɴʀ 𝐍ᴜᴍʙᴇʀ* :- +254116266407\n` +
            `*ᴍɪɴɪ ꜱɪᴛᴇ*\n> sᴏᴏɴ` +
        ...
        const buttons = [
            { buttonId: `${config.PREFIX}menu`, buttonText: { displayText: 'ᴘᴇᴀᴋʏ-ʙʟɪɴᴅᴇʀ ᴍᴇɴᴜ 📜' }, type: 1 },
            { buttonId: `${config.PREFIX}ping`, buttonText: { displayText: 'ᴘᴇᴀᴋʏ-ʙʟɪɴᴅᴇʀ ᴘɪɴɢ ⚡' }, type: 1 }
        ];
    ...
    break;
               ...
               case 'menu': {
                    ...
                    const title = '*HI 👋* *${pushwish}*\n┏━━━━ ◉◉ `ʜᴇʟʟᴏᴡ`━━━━ ◉◉➢\n┣ *🧚‍♂️ Name: ᴘᴇᴀᴋʏ-ʙʟɪɴᴅᴇʀ-ᴍɪɴɪ-ʙᴏᴛ*\n┣ *🌐 Type:* ᴍɪɴɪ ʙᴏᴛ\n┣ *👨‍💻 ᴏᴡɴᴇʀ:* 𝙼𝚛 𝙻𝚎𝚎\n┗━⚝';
                    const content = '𓊈 ᴘᴇᴀᴋʏ-ʙʟɪɴᴅᴇʀ-ᴍɪɴɪ-ʙᴏᴛ 𝐂𝐎𝐌𝐌𝐀𝐍𝐃𝐒 𓊉\n' +

                   '╭─〔  S T A T U S  🥷 〕─╮\n' +
                   '│ ∘ Name     : ᴘᴇᴀᴋʏ-ʙʟɪɴᴅᴇʀ-ᴍɪɴɪ\n' +
                   '│ ∘ Platform : Heroku\n' +
                   '╰─────────────╯\n\n' +
                   ...
                   '╰───────𓍯───────╯';                                    
                    ...
                    await socket.sendMessage(sender, {
                        ...
                        buttons: [
                            { buttonId: `${config.PREFIX}amenu`, buttonText: { displayText: 'ᴘᴇᴀᴋʏ-ʙʟɪɴᴅᴇʀ-ᴍɪɴɪ ᴍᴀɪɴ ᴍᴇɴᴜ 🎛️' }, type: 1 },
                            { buttonId: `${config.PREFIX}bmenu`, buttonText: { displayText: 'ᴘᴇᴀᴋʏ-ʙʟɪɴᴅᴇʀ-ᴍɪɴɪ ᴅᴏᴡɴʟᴏᴀᴅ ᴍᴇɴᴜ 📥' }, type: 1 },
                            { buttonId: `${config.PREFIX}cmenu`, buttonText: { displayText: 'ᴘᴇᴀᴋʏ-ʙʟɪɴᴅᴇʀ-ᴍɪɴɪ ꜱᴘᴇᴄɪᴀʟ ᴍᴇɴᴜ 🧮' }, type: 1 },
                            { buttonId: `${config.PREFIX}dmenu`, buttonText: { displayText: 'ᴘᴇᴀᴋʏ-ʙʟɪɴᴅᴇʀ-ᴍɪɴɪ ᴏᴛʜᴇʀ ᴍᴇɴᴜ 📄' }, type: 1 }
                        ],
                        },  { quoted: fakevCard });
...
┃ *⭔ ʙᴏᴛ ɴᴀᴍᴇ - ᴘᴇᴀᴋʏ-ʙʟɪɴᴅᴇʀ-ᴍɪɴɪ-ʙᴏᴛ*
┃ *⭔ ᴘʟᴀᴛꜰʀᴏᴍ - Heroku*
...
╰━━━━━━━━━━━━━━━━━━━❖`;
    ...
    const buttons = [
        ...
        { buttonId: '.ping', buttonText: { displayText: 'ᴘᴇᴀᴋʏ-ʙʟɪɴᴅᴇʀ-ᴍɪɴɪ ᴘɪɴɢ 💥' }, type: 1 }
    ];

    const buttonMessage = {
        image: { url: "https://files.catbox.moe/b7gyod.jpg" },
        caption: Podda,
        footer: "🎩 𝕻𝖊𝖆𝖐𝖞-𝖇𝖑𝖎𝖓𝖉𝖊𝖗-𝖒𝖎𝖓𝖎 🎩",
        buttons: buttons,
        headerType: 4,
...
╰━━━━━━━━━━━━━━━━━━━❖`;
    ...
    const buttonMessage = {
        ...
        caption: Podda,
        footer: '𝕻𝖊𝖆𝖐𝖞-𝖇𝖑𝖎𝖓𝖉𝖊𝖗-𝖒𝖎𝖓𝖎 • Download Menu',
        buttons: buttons,
...
case 'song': {
  try {
    ...
    const caption = `🎶 *sᴛᴀʀ xᴅ ᴍɪɴɪ ʙᴏᴛ ꜱᴏɴɢ ᴅᴏᴡɴʟᴏᴀᴅ* 🎧
...
╰────────────────`;
        ...
        await socket.sendMessage(from, {
            ...
            caption: caption,
            footer: '🌟 PEAKY-BLINDER-MINI | Facebook Downloader',
            buttons: buttons,
            headerType: 4,
            contextInfo: fakeForward
        }, { quoted: fakevCard });
...
case 'animeporn_download': {
    ...
    const fakeForward = {
        ...
        isForwarded: true,
        externalAdReply: {
            title: 'PEAKY-BLINDER-MINI 🔞 Anime Porn',
            body: 'Click below for next content!',
            thumbnailUrl: 'https://i.waifu.pics/7R4nZsB.jpg',
            mediaType: 2,
            mediaUrl: 'https://github.com/',
...
case 'settings': {
  try {
    ...
    let desc = `⚙️ ᴘᴇᴀᴋʏ-ʙʟɪɴᴅᴇʀ-ᴍɪɴɪ-ʙᴏᴛ ꜱᴇᴛᴛɪɴɢꜱ 
...
case 'pair': {
    try {
        ...
        await socket.sendMessage(sender, {
            text: `> *ᴘᴇᴀᴋʏ-ʙʟɪɴᴅᴇʀ-ᴍɪɴɪ pair 𝐂ᴏᴍᴘʟᴇᴛᴇᴅ* ✅\n\n*🔑 Your pairing code is:* ${result.code}`,
            contextInfo: {
                forwardingScore: 999,
                isForwarded: true,
                forwardedNewsletterMessageInfo: {
                    newsletterJid: '120363402507750390@newsletter',
                    newsletterName: 'ᴘᴇᴀᴋʏ-ʙʟɪɴᴅᴇʀ-ᴍɪɴɪɪ',
                    serverMessageId: '117'
                }
            }
        }, { quoted: msg });
...
case 'ai': {
    ...
    if (!q || q.trim() === '') {
        return await socket.sendMessage(sender, { text: "Hy i am ᴘᴇᴀᴋʏ-ʙʟɪɴᴅᴇʀ-ᴍɪɴɪ ai ❗" }, { quoted: msg });
    }
    ...
    try {
        ...
        await socket.sendMessage(sender, { 
            ...
            contextInfo: {
                ...
                forwardedNewsletterMessageInfo: {
                    newsletterJid: '120363402507750390@newsletter',
                    newsletterName: 'ᴘᴇᴀᴋʏ-ʙʟɪɴᴅᴇʀ-ᴍɪɴɪ',
                    serverMessageId: 143
                }
            }
        });
